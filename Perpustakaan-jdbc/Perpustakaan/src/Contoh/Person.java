...
//----------------------------------
     ...
     */
    public Person() {
        this("Not Given", 0, 'U', new Resident("aku","R1","pwd1"));
    }
     ...
     */
    public Person(String name, int age, char gender,Resident r) {
        this.age    = age;
        this.name   = name;
        this.gender = gender;
        this.p=r;
