...
public class frPegawai extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String vLoc=jTextField2.getText();
        String vSalary=jTextField3.getText();
        String vDate=jTextField4.getText();
         
        try{
            if( vName.matches(".*[^a-zA-Z\\s+].*")) {throw new Exception("Nama harus berupa alfabet");}
