...
public class JDialog_KoleksiDisk_205314020 extends javax.swing.JDialog {

    DataPenyimpanan_205314020 data;
    ArrayList<Koleksi_205314020> DiskList = new ArrayList<>();
    DataPenyimpanan_205314020 dataKoleksi;
    TableColumnModel columnModel;
    DefaultTableModel tabelModel;

    public JDialog_KoleksiDisk_205314020(java.awt.Frame parent, boolean modal, DataPenyimpanan_205314020 data) {
        super(parent, modal);
        initComponents();
        this.data = data;
    ...
    public void tampilDataKoleksiBuku() {
        ...
        int i = 0;
        for (Koleksi_205314020 n : DiskList) {
            if (n instanceof Disk_205314020) {
                ...
                String[] arrData = {n.getId_koleksi(), n.getJudul(), n.getPenerbit(), n.getTahunTerbit(),
                    n.isStatus_pinjam() ? "Dipinjam" : "Tersedia", String.valueOf(((Disk_205314020) n).getFormat()), ((Disk_205314020) n).getISBN()};
    ...
    public ArrayList<Koleksi_205314020> ambilDataKoleksiBuku() {
        ...
        try {
            ...
            while (rset.next()) {
                //id_koleksi, judul, penerbit, tahun_terbit, status_pinjam, format, isbn
                Koleksi_205314020 temp = new Disk_205314020(rset.getString("id_koleksi"), rset.getString("judul"), rset.getString("penerbit"), rset.getString("tahun_terbit"), rset.getBoolean("status_pinjam"), rset.getString("format"), rset.getString("isbn"));
                result.add(temp);
            }
...
//            public void run() {
//                JDialog_KoleksiDisk_205314020 dialog = new JDialog_KoleksiDisk_205314020(new javax.swing.JFrame(), true);
